	...
	protected function set_button_labels() {
		...
		$this->button_labels = wp_parse_args( $this->button_labels,
			...
			array(
				...
				'select'       => esc_attr__( 'Select image', 'lucia' ),

				'change'       => esc_attr__( 'Change image', 'lucia' ),

				'default'      => esc_attr__( 'Default', 'lucia' ),

				'remove'       => esc_attr__( 'Remove', 'lucia' ),

				'placeholder'  => esc_attr__( 'No image selected', 'lucia' ),

				'frame_title'  => esc_attr__( 'Select image', 'lucia' ),

				'frame_button' => esc_attr__( 'Choose image', 'lucia' ),
