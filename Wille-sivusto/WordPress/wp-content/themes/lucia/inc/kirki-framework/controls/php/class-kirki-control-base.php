	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'lucia' ),

				'remove'               => esc_attr__( 'Remove', 'lucia' ),

				'default'              => esc_attr__( 'Default', 'lucia' ),

				'selectFile'           => esc_attr__( 'Select File', 'lucia' ),

				'standardFonts'        => esc_attr__( 'Standard Fonts', 'lucia' ),

				'googleFonts'          => esc_attr__( 'Google Fonts', 'lucia' ),

				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'lucia' ),

				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'lucia' ),
