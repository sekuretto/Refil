...
class Kirki_Control_Repeater extends Kirki_Control_Base {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( empty( $this->button_label ) ) {
			...
			$this->button_label = sprintf( esc_attr__( 'Add new %s', 'lucia' ), $this->row_label['value'] );
					...
					case 'dropdown-pages':
						...
						$dropdown = wp_dropdown_pages(
							...
							array(
								...
								'show_option_none'  => esc_attr__( 'Select a Page', 'lucia' ),
	...
	protected function render_content() {
		...
		<?php if ( isset( $this->choices['limit'] ) ) : ?>
			...
			<p class="limit"><?php printf( esc_attr__( 'Limit: %s rows', 'lucia' ), esc_html( $this->choices['limit'] ) ); ?></p>
		...
		<script type="text/html" class="customize-control-repeater-content">
			...
			<li class="repeater-row minimized" data-row="{{{ index }}}">
				...
				<div class="repeater-row-content">
					...
					<# _.each( data, function( field, i ) { #>
						...
						<div class="repeater-field repeater-field-{{{ field.type }}} repeater-field-{{ field.id }}">
							...
							<# } else if ( 'color' === field.type ) { #>
								...
								<input class="color-picker-hex" type="text" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'lucia' ); ?>"  value="{{{ field.default }}}" data-field="{{{ field.id }}}" {{ defaultValue }} />
							...
							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
								...
								<figure class="kirki-image-attachment" data-placeholder="<?php esc_attr_e( 'No Image Selected', 'lucia' ); ?>" >
									...
									<# } else { #>
										...
										<?php esc_attr_e( 'No Image Selected', 'lucia' ); ?>
								...
								<div class="actions">
									...
									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php esc_attr_e( 'Remove', 'lucia' ); ?></button>

									<button type="button" class="button upload-button" data-label=" <?php esc_attr_e( 'Add Image', 'lucia' ); ?>" data-alt-label="<?php echo esc_attr_e( 'Change Image', 'lucia' ); ?>" >

										<# if ( field.default ) { #>

											<?php esc_attr_e( 'Change Image', 'lucia' ); ?>

										<# } else { #>

											<?php esc_attr_e( 'Add Image', 'lucia' ); ?>
							...
							<# } else if ( field.type === 'upload' ) { #>
								...
								<figure class="kirki-file-attachment" data-placeholder="<?php esc_attr_e( 'No File Selected', 'lucia' ); ?>" >
									...
									<# } else { #>
										...
										<?php esc_attr_e( 'No File Selected', 'lucia' ); ?>
								...
								<div class="actions">
									...
									<button type="button" class="button upload-button" data-label="<?php esc_attr_e( 'Add File', 'lucia' ); ?>" data-alt-label="<?php esc_attr_e( 'Change File', 'lucia' ); ?>">

										<# if ( field.default ) { #>

											<?php esc_attr_e( 'Change File', 'lucia' ); ?>

										<# } else { #>

											<?php esc_attr_e( 'Add File', 'lucia' ); ?>
					...
					<button type="button" class="button-link repeater-row-remove"><?php esc_attr_e( 'Remove', 'lucia' ); ?></button>
