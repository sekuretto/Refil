...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			...
			select: '<?php esc_attr_e( 'Select image', 'lucia' ); ?>',

			change: '<?php esc_attr_e( 'Change image', 'lucia' ); ?>',

			'default': '<?php esc_attr_e( 'Default', 'lucia' ); ?>',

			remove: '<?php esc_attr_e( 'Remove', 'lucia' ); ?>',

			placeholder: '<?php esc_attr_e( 'No image selected', 'lucia' ); ?>',

			frame_title: '<?php esc_attr_e( 'Select image', 'lucia' ); ?>',

			frame_button: '<?php esc_attr_e( 'Choose image', 'lucia' ); ?>',
