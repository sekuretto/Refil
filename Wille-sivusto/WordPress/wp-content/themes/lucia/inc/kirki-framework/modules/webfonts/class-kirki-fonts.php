...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		...
		return array(
			...
			'100'       => esc_attr__( 'Ultra-Light 100', 'lucia' ),

			'100light'  => esc_attr__( 'Ultra-Light 100', 'lucia' ),

			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'lucia' ),

			'200'       => esc_attr__( 'Light 200', 'lucia' ),

			'200italic' => esc_attr__( 'Light 200 Italic', 'lucia' ),

			'300'       => esc_attr__( 'Book 300', 'lucia' ),

			'300italic' => esc_attr__( 'Book 300 Italic', 'lucia' ),

			'400'       => esc_attr__( 'Normal 400', 'lucia' ),

			'regular'   => esc_attr__( 'Normal 400', 'lucia' ),

			'italic'    => esc_attr__( 'Normal 400 Italic', 'lucia' ),

			'500'       => esc_attr__( 'Medium 500', 'lucia' ),

			'500italic' => esc_attr__( 'Medium 500 Italic', 'lucia' ),

			'600'       => esc_attr__( 'Semi-Bold 600', 'lucia' ),

			'600bold'   => esc_attr__( 'Semi-Bold 600', 'lucia' ),

			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'lucia' ),

			'700'       => esc_attr__( 'Bold 700', 'lucia' ),

			'700italic' => esc_attr__( 'Bold 700 Italic', 'lucia' ),

			'800'       => esc_attr__( 'Extra-Bold 800', 'lucia' ),

			'800bold'   => esc_attr__( 'Extra-Bold 800', 'lucia' ),

			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'lucia' ),

			'900'       => esc_attr__( 'Ultra-Bold 900', 'lucia' ),

			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'lucia' ),

			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'lucia' ),
