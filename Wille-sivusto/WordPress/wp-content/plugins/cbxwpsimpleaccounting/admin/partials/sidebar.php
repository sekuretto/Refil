...
<div id="postbox-container-1" class="postbox-container">
    <div class="meta-box-sortables">
        ...
        <div class="postbox">
                                <h3><?php _e('Help & Supports','cbxwpsimpleaccounting'); ?></h3>
                                <div class="inside">
	                        ...
	                        <div class="postbox">
		                        <h3><?php _e('Codeboxr Updates','cbxwpsimpleaccounting'); ?></h3>
		                        <div class="inside">
			                        <?php
	                        ...
	                        <div class="postbox">
		                        <h3><?php _e('Codeboxr on facebook','cbxwpsimpleaccounting') ?></h3>
		                        <div class="inside">
